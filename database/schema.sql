...
(
    ...
    index             idx_precios_categoria_empresa (empresa_id),
...
(
    ...
    index          idx_caja_empresa (empresa_id),
...
(
    ...
    index             idx_cxc_empresa (empresa_id),
...
(
    ...
    index                idx_abono_empresa (empresa_id),
    index                idx_abono_cuenta (cuenta_por_cobrar_id),
    index                idx_abono_caja (caja_id),

    foreign key (empresa_id) references empresas (id) on update cascade,
    foreign key (cuenta_por_cobrar_id) references cuentas_por_cobrar (id) on update cascade on delete cascade,
...
(
    ...
    index            idx_mov_empresa (empresa_id),
...
values ('SUPER_ADMIN', 'Administrador total del sistema'),
       ('ADMIN_EMPRESA', 'Administrador de una empresa'),
       ('VENDEDOR', 'Usuario para ventas'),
       ('CAJA', 'Usuario para caja y movimientos'),
       ('SUPERVISOR', 'Usuario supervisor') on duplicate key
update descripcion =
values (descripcion);